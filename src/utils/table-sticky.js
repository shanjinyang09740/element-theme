...
export default {
    ...
    methods: {
        ...
        async initFixedHeader() {
            if (this.parent) {
                ...
                if (this.parentDom && this.parentDom.length !== 0) {
                    this.tableWidth = this.parentDom[0]
                        .querySelector(".el-table__header-wrapper")
                        .getBoundingClientRect().width;
                    this.setScrollXWidth();
                    this.tableDom = this.parentDom[0].getElementsByClassName(
        ...
        updateWidth() {
            if (!this.parentDom)
                this.parentDom = document.getElementsByClassName(this.parent);
            const bodyWrapperDom = this.parentDom[0].getElementsByClassName(
        ...
        scrollEvent: rafThrottle(async function(e) {
            ...
            this.fixedRightDom = this.parentDom[0].getElementsByClassName(
                "el-table__fixed-right"
            );
            this.fixedLeftDom =
                this.parentDom[0].getElementsByClassName("el-table__fixed");
